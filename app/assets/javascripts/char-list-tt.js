...
function addRow() {
  ...
  if (document.getElementById('selected-opt-1').checked) {
    selectedOpt = document.getElementById('selected-opt-1').value;
  } else if (document.getElementById('selected-opt-2').checked) {
    selectedOpt = document.getElementById('selected-opt-2').value;
  }

  var optCell = row.insertCell(1);
  optCell.innerHTML = selectedOpt;
  optCell.id = 'option-' + selectedOpt;
  optCell.className = 'govuk-table__cell';
